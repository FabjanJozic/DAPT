        ...
        DO 100 I = 1, N - 1
           ...
           DO 99 J = I + 1, N
              ...
              IF ( RIJSQ .LT. SIGSQ ) THEN
                 ...
                 WRITE(*,'('' I,J,RIJ/SIGMA = '',2I5,F15.8,2(3f10.5))')
     :              I, J, RIJ, rxi,ryi,rzi, rx(j),ry(j),rz(j)
...
C    *******************************************************************
        ...
        DO I=1,NN
        READ ( CNUNIT, * ) RX(I), RY(I), RZ(I) , VX(I), VY(I), VZ(I)
c        READ ( CNUNIT ) VX, VY, VZ
        ENDDO
        CLOSE ( UNIT = CNUNIT )
...
c    :        , STATUS = 'UNKNOWN', FORM = 'UNFORMATTED' )
        ...
        WRITE ( CNUNIT,* ) N, xx, densty
        DO I = 1 , N
        WRITE ( CNUNIT,11) RX(I), RY(I), RZ(I),  VX(I), VY(I), VZ(I)
        ENDDO
        
 11     format(2(3f15.8,3x))
